...
\Proposition{
	...
	\LogicProof{
		...
		\LogicProofStatement
		{	\ConditionalProofArray{ConverseImplicationPremise}{5.}
		}{	$Q \cdot P$
		}{	Assumed Premise
		}
		\LogicProofStatement
		...
		}{	\ConditionalProofArray{ConverseImplicationConclusion}{5, 7, Conditional Proof}
		}
		\LogicProofStatement
		{	9.
	...
	\ConditionalProofArrayImplement{ConverseImplicationPremise}{ConverseImplicationConclusion}{2.3}
}
\Remark{
...
\Claim{
	...
	\LogicProof{
		...
		}{	\ConditionalProofArray{ImplicationConclusion}{1, 4, Conditional Proof}
		}
		\LogicProofStatement
		{	\ConditionalProofArray{ConverseImplicationPremise}{6.}
		}{	$P$ $\lor$ $Q$
		}{	Assumed Premise
		}
		\LogicProofStatement
		...
		}{	\ConditionalProofArray{ConverseImplicationConclusion}{6, 9, Conditional Proof}
		}
		\LogicProofStatement
		{	11.
		}{	($P$ $\lor$ $Q$) $\iff$ ($\neg{Q}$ $\implies$ $P$)
